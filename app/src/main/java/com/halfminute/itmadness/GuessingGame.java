...
public class GuessingGame extends AppCompatActivity {
    ...
    public void onBackPressed()
    {
        super.onBackPressed();
        countDownTimer.cancel();
        Intent intent = new Intent(GuessingGame.this, ChooseGame.class);
        startActivity(intent);
        finish();
    }
    ...
    private void startGame() {
        ...
        countDownTimer = new CountDownTimer(millisUntilFinished, 1000) {
            ...
            public void onTick(long millisUntilFinished) {
                ...
                if(seconds <= 5){
                    if (seconds == 5){
                        timerPlayer = MediaPlayer.create(GuessingGame.this, R.raw.five_sec_countdown);
                        playTimerSound();
                    }
    ...
    private void gameOver(){
        ...
        editor.putString("actualGame", "math");
        editor.apply();
        Intent intent = new Intent(GuessingGame.this, GameOver.class);
