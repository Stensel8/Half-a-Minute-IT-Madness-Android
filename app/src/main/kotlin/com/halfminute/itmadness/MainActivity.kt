...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.TIRAMISU) {
            // Print a warning message when the Android version is lower than 11
            sharedPref.showCustomSnackbar(this, "Let op: Deze app wordt aanbevolen op Android 11 of hoger.")
        }
    ...
    fun chooseGamePage(view: View?) {
        view?.let {
            ...
            try {
                ...
                // Vang de fout op bij het starten van ChooseGame-activiteit
                sharedPref.showCustomSnackbar(this, "Fout bij het starten van het spel")
                e.printStackTrace()
            }
        }
    }
    ...
    fun goSettings(view: View?) {
        view?.let {
            ...
            try {
                ...
                // Vang de fout op bij het starten van Settings-activiteit
                sharedPref.showCustomSnackbar(this, "Fout bij het openen van de instellingen")
                e.printStackTrace()
            }
        }
    }
